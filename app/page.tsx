  ...
  return (
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        {view === "dashboard" && <section className="home-command-hero"><div className="home-command-copy"><p>Welcome to your academic workspace</p><h2>School Management Overview</h2><span>Monitor current performance, open teaching resources and move quickly between the school&apos;s assessment tools.</span><div><button className="primary" onClick={() => setView("scorebook")}><Icon name="book" size={18}/>Open Scorebook</button><button className="home-hero-secondary" onClick={() => setView("reports")}><Icon name="chart" size={18}/>View Reports</button></div></div><div className="home-crest"><img src="/school-logo.png" alt="1st November 1954 J.H.S. crest"/><span>1ST NOVEMBER 1954 J.H.S.</span><small>Lord, increase me in knowledge</small></div></section>}
        ...
        {(view === "scorebook" || view === "dashboard") && <>
          ...
          {view === "dashboard" && <section className="home-quick-access" aria-label="Quick access"><button onClick={() => setView("resources")}><span className="green"><Icon name="folder" size={22}/></span><div><strong>Teaching Resources</strong><small>Schemes, lesson notes and questions</small></div><b>→</b></button><button onClick={() => setView("scorebook")}><span className="navy"><Icon name="book" size={22}/></span><div><strong>Assessment Scorebook</strong><small>View learners and recorded scores</small></div><b>→</b></button><button onClick={() => void loadOverallPerformance()}><span className="gold"><Icon name="chart" size={22}/></span><div><strong>Overall Performance</strong><small>Compare Red and Blue streams</small></div><b>→</b></button></section>}
          ...
          {view === "scorebook" && <ScoreTable students={visible} loading={loading} onManageStudents={() => { setView("headteacher"); setHeadManagementSection("students"); }} />}
